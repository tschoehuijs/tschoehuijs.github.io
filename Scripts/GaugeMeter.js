  ...
  $.fn.gaugeMeter = function (t) {
    ...
    return this.each(function () {
      ...
      function getThemeColor(e) {
        ...
        "Temperature" === option.theme && (e > 0 && (t = "#0000FF"), e > 10 && (t = "#332bcc"), e > 20 && (t = "#665699"), e > 30 && (t = "#998166"), e > 40 && (t = "#ffd700"), e > 50 && (t = "#ffb300"), e > 60 && (t = "#ff8f00"), e > 70 && (t = "#ff6c00"), e > 80 && (t = "#ff4800"), e > 90 && (t = "#ff0000")),
      ...
      if( option.text !== "" && option.text !== null && option.text !== undefined){
        ...
        if(option.append !== "" && option.append !== null && option.append !== undefined){
          if(Number.isInteger(option.used)){
            ...
            r = r + "<u>" + option.append + "</u>"; //data?
          }
        }
      }

      if(Number.isInteger(option.used) && Number.isInteger(option.total)){
        c = option.used / option.total * 100; // to determine value
      } else {
